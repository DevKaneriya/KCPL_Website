...
@Component({
  selector: 'app-manufacturing-in-house',
  imports: [CommonModule],
  templateUrl: './manufacturing-in-house.html',
  styleUrl: './manufacturing-in-house.scss'
})
export class ManufacturingInHouse {
  ...
  ngOnInit(): void {
    const blackText = 'Manufacturing Infrastructure';
    const blueText = '';
    const reblackText = '';
