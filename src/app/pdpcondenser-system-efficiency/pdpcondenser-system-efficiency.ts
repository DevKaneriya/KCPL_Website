...
@Component({
  selector: 'app-pdpcondenser-system-efficiency',
  imports: [CommonModule],
  templateUrl: './pdpcondenser-system-efficiency.html',
  styleUrl: './pdpcondenser-system-efficiency.scss'
})
export class PdpcondenserSystemEfficiency {
  ...
  ngOnInit(): void {
    const blackText = 'How KCPL Condensers';
    const blueText = 'Maximize System';
    const reblackText = 'Efficiency';
