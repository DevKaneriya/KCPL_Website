...
@Component({
  selector: 'app-quality-philosophy',
  imports: [CommonModule],
  templateUrl: './quality-philosophy.html',
  styleUrl: './quality-philosophy.scss'
})
export class QualityPhilosophy {
  ...
  ngOnInit(): void {
    const blackText = 'Supplier Quality Management ';
    const blueText = '';
    const reblackText = '';
