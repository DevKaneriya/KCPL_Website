...
@Component({
  selector: 'app-manufacturing-stringent-quality',
  imports: [CommonModule],
  templateUrl: './manufacturing-stringent-quality.html',
  styleUrl: './manufacturing-stringent-quality.scss'
})
export class ManufacturingStringentQuality {
  ...
  ngOnInit(): void {
    const blueText = 'STRINGENT QUALITY';
    const blackText = 'CHECKS AT EVERY STAGE';
    ...
    this.letters = [...mapWords(blueText, true), ...mapWords(blackText, false), ...mapWords(reblackText, false)];
  }
