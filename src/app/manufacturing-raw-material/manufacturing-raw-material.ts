...
@Component({
  selector: 'app-manufacturing-raw-material',
  imports: [CommonModule],
  templateUrl: './manufacturing-raw-material.html',
  styleUrl: './manufacturing-raw-material.scss'
})
export class ManufacturingRawMaterial {
  ...
  ngOnInit(): void {
    const blackText = 'Advanced Production & Assembly Systems';
    const blueText = '';
    const reblackText = '';
