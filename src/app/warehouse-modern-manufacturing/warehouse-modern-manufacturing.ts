...
@Component({
  selector: 'app-warehouse-modern-manufacturing',
  imports: [CommonModule],
  templateUrl: './warehouse-modern-manufacturing.html',
  styleUrl: './warehouse-modern-manufacturing.scss'
})
export class WarehouseModernManufacturing {
