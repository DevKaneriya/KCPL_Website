...
@Component({
  selector: 'app-warehouse-centralized-storage',
  imports: [CommonModule],
  templateUrl: './warehouse-centralized-storage.html',
  styleUrl: './warehouse-centralized-storage.scss'
})
export class WarehouseCentralizedStorage {
  ...
  ngOnInit(): void {
    const blackText = 'Centralized Storage. Streamlined Systems.';
    const blueText = '';
    const reblackText = '';
