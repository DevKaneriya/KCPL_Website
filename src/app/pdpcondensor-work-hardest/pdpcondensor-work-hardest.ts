...
@Component({
  selector: 'app-pdpcondensor-work-hardest',
  imports: [CommonModule],
  templateUrl: './pdpcondensor-work-hardest.html',
  styleUrl: './pdpcondensor-work-hardest.scss'
})
export class PdpcondensorWorkHardest {
