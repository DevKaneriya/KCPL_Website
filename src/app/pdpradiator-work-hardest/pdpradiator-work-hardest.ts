...
@Component({
  selector: 'app-pdpradiator-work-hardest',
  imports: [CommonModule],
  templateUrl: './pdpradiator-work-hardest.html',
  styleUrl: './pdpradiator-work-hardest.scss'
})
export class PdpradiatorWorkHardest {
  ...
  ngOnInit(): void {
    const blackText = 'Where Our Radiators';
    const blueText = ' Work Hardest';
